...
- Footnotes/endnotes inserted
- Inline text cleaned
- Word comments for flagged issues
- Supra/id. short forms applied
...
def assemble_document(
    ...
    Args:
        ...
        use_endnotes: Use endnotes instead of footnotes
    ...
    fn_manager = FootnoteManager(doc, use_endnotes=use_endnotes)
    ...
    # Apply supra/id. — we need to assign temporary note IDs first
