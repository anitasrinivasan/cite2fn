...
Usage:
    ...
    python -m cite2fn.cli assemble <input.docx> <citations.json> [-o output.docx] [--endnotes]
"""
...
def cmd_assemble(args: list[str]) -> None:
    """Assemble the final document with footnotes, cleanup, comments, and supra/id.
    ...
    parser.add_argument("--endnotes", action="store_true", help="Use endnotes instead of footnotes")
    parser.add_argument("--keep-references", action="store_true", help="Don't remove References section")
